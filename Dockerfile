...
#
# Single image serving BOTH transports of the vgi-etf-first-trust worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-first-trust

LABEL org.opencontainers.image.title="vgi-etf-first-trust" \
      org.opencontainers.image.description="First Trust US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
